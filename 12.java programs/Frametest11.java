...
class Frametest11{
	...
	Label l1=new Label("Enter Seconds");
	Label l2=new Label("Hours");
	Label l3=new Label("Minutes");
	Label l4=new Label("Seconds");
	...
	Frametest11(){
		...
		l2.setBounds(20,80,90,30);
		l3.setBounds(20,120,90,30);
		l4.setBounds(20,160,90,30);
		
		t1.setBounds(130,80,100,30);
		t2.setBounds(130,120,100,30);
		t3.setBounds(130,160,100,30);
		t4.setBounds(130,40,100,30);
	...
	public static void main(String arg[]){
		...
		Frametest11 as=new Frametest11();
