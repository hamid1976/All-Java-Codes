...
class Calculatoroperater{
	...
	void operater(){
		...
		System.out.print("\nEnter Two Value ");
				...
				switch(op3){
					case "+":System.out.print("Addition is: "+(op1+op2));break;
					case "-":System.out.print("Subtration is: "+(op1-op2));break;
					case "*":System.out.print("Multiplication is: "+(op1*op2));
					case "x":System.out.print("Multiplication is: "+(op1*op2));
					case "X":System.out.print("Multiplication is: "+(op1*op2));
					case "/":System.out.print("Divison is: "+(op1/op2));
					case "\\":System.out.print("Divison is: "+(op1/op2));
					case "%":System.out.print("Remainder is: "+(op1%op2));
