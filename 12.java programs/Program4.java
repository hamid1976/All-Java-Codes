	...
	public static void main(String arg[]){
		...
		while(mini==1){
			...
			while(cl==1){
				...
				switch(menu){
					case 1:System.out.print("Enter Two Value ");
					      ...
					      int add3=cc.add(add1,add2);
						  System.out.print("Addition is: "+add3);
						  break;
					case 2:System.out.print("Enter Two Value ");
		                   int sub1=as.nextInt();
				    	   int sub2=as.nextInt();
					
					       int sub3=cc.sub(sub1,sub2);
						   System.out.print("Subtraction is: "+sub3);
						   break;
					case 3:System.out.print("Enter Two Value ");
		                   int mul1=as.nextInt();
				    	   int mul2=as.nextInt();
					
					       int mul3=cc.mul(mul1,mul2);
						    System.out.print("Multiplication is: "+mul3);
							break;
					case 4:System.out.print("Enter Two Value ");
		                   int div1=as.nextInt();
				    	   int div2=as.nextInt();
					
					       int div3=cc.div(div1,div2);
						   System.out.print("Divison is: "+div3);
						   break;
					case 5:System.out.print("Enter Two Value ");
					       ...
					       int rem3=cc.rem(rem1,rem2);
						    System.out.print("Remainder is: "+rem3);
							break;
			...
			if(cl==2){
				...
				int opt4=cc1.operater("+",opt1,opt2);
				int opt5=cc1.operater("-",opt1,opt2);
				int opt6=cc1.operater("*",opt1,opt2);
				int opt7=cc1.operater("x",opt1,opt2);
				int opt8=cc1.operater("X",opt1,opt2);
				int opt9=cc1.operater("/",opt1,opt2);
				int opt10=cc1.operater("//",opt1,opt2);
				int opt11=cc1.operater("%",opt1,opt2);
				
				System.out.println("Addition is: "+opt4);
				System.out.println("Subtraction is: "+opt5);
				System.out.println("Multiplication is: "+opt6);
				System.out.println("Multiplication is: "+opt7);
				System.out.println("Multiplication is: "+opt8);
				System.out.println("Divisor is: "+opt9);
				System.out.println("Divisor is: "+opt10);
				System.out.println("Remainder is: "+opt11);
		...
		//(==2.unit convertor Start==)
			while(mini==2){
				...
				switch(uc){
					case 1:cc2.unit1();break;
					case 2:cc2.unit2();break;
					case 3:cc2.unit3();break;
					case 4:cc2.unit4();break;
					case 5:cc2.unit5();break;
					case 6:cc2.unit6();break;
			...
			//(== 5.Atm Start==)
			if(mini==5){cc5.rupees();}
			//(== 5.Atm End==)
			
			//(== 6.Employ Start==)
			if(mini==6){cc6.salary();}
			//(== 6.Employ End==)
			...
			while(mini==10){
				...
				switch(ls){
					case 1:cc10.even();break;
					case 2:cc10.odd();break;
					case 3:cc10.sqr();break;
					case 4:cc10.table();break;
					case 5:cc10.factorial();break;
					case 6:cc10.fibonaicii();break;
					case 7:cc10.prime();break;
				}
				if(ls==8){break;}
...
class Calculatoroperater{
	...
	int operater(String op3 ,int op1,int op2){
		
				
				switch(op3){
					case "+":op1=op1+op2; break;
					case "-":op1=op1-op2; break;
					case "*":return  op1=op1*op2; break; 
