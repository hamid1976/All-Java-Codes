	...
	public static void main(String[] args) {
        ...
        while(ch=='Y'){
            ...
            while(mm==2){
	            ...
	            int con=op.nextInt();
            	switch(con){
            		case 1: System.out.print("Enter Centimeter : ");
	    					int centi=op.nextInt();
            				uc.cf(centi);
            				break;
            		case 2: System.out.print("Enter Kilometer : ");
	    					int yard=op.nextInt();
            				uc.ky(yard);
            				break;
            		case 3: System.out.print("Enter Kilometer : ");
	    					int meter=op.nextInt();
            				uc.km(meter);
            				break;
            		case 4: System.out.print("Enter Meter : ");
	    					int myt=op.nextInt();
            				uc.my(myt);
            				break;
    		...
    		while(mm==10){
            	...
            	switch(lssel){
            		case 1: System.out.print("Enter Any Number : ");
							int num20=op.nextInt();
            				ls.evennumber(num20);
            		break;
            		case 2: System.out.print("Enter Any Number : ");
							int num21=op.nextInt();
            				ls.oddnumber(num21);
            		break;
            		case 3: System.out.print("Enter Any Number : ");
							int num22=op.nextInt();
            				ls.sqrcube(num22);
            		break;
            		case 4: System.out.print("Enter Table No : ");
							...
							ls.table(t20,c20);
            		break;
            		case 5: System.out.print("Enter Any Number : ");
							int num24=op.nextInt();
            				ls.primenumber(num24);
            		break;
            		case 6: System.out.print("Enter Any Number : ");
							int num25=op.nextInt();
            				ls.evenodd(num25);
            		break;
            		case 7: System.out.print("Enter Any Number : ");
							int num26=op.nextInt();
            				ls.star(num26);
            		break;
            	}
            	if (lssel==8)
...
class CalculatorMenu{
	...
	void operator(int a,int b,char s){
		switch(s){
